<template>
      ...
      <div class="slider_container">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-5 ">
              <div class="img-box">
                <img src="../assets/img/mv-img.png" alt="" />
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="shop_section layout_padding">
    <div class="container">
      ...
      <div class="sec-product flex">
        <div class="product-box" v-for="product in selectedProducts">
          <div class="box">
            <a href="">
              <div class="img-box">
...
const selectedProducts = products.value.slice(0, 9);
